...
function Game(props) {
  ...
  const [playerMessage, setPlayerMessage] = useState("Start the game!");
  ...
  function handleClick(i) {
    ...
    if (winner) {
      ...
      setPlayerMessage(`Turn of ${xIsNext ? "O" : "X"}`);
      setXIsNext(!xIsNext);
    }
  }
  ...
  function resetGame() {
    ...
    setXIsNext(true);
    setPlayerMessage("Start the game");
    setWinner(null);
